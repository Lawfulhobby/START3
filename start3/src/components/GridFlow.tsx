...
const TitleCard = () => {
    return (
        <a
            href="/create-flow"
            className="group relative flex h-[150px] flex-col justify-between bg-neutral-950 p-6 md:p-9 transition-all duration-500 ease-in-out rounded-none hover:rounded-lg"
        >
