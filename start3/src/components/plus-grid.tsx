...
export function PlusGridRow({
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute inset-x-0 top-0 border-t border-purple/5"></div>
        <div className="absolute inset-x-0 top-2 border-t border-purple/5"></div>
        <div className="absolute inset-x-0 bottom-0 hidden border-b border-purple/5 group-last/row:block"></div>
        <div className="absolute inset-x-0 bottom-2 hidden border-b border-purple/5 group-last/row:block"></div>
      </div>
      {children}
    </div>
  )
