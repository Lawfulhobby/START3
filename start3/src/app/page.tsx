  ...
  return (
    <div className=" bg-background">
      ...
      <div className="relative isolate overflow-hidden  pt-14">
        <div
          aria-hidden="true"
          className="absolute bg-background p-4 text-primary inset-y-0 right-1/2 -z-10 -mr-96 w-[200%] origin-top-right skew-x-[-30deg] shadow-xl shadow-[#7C00FF]  sm:-mr-80 lg:-mr-96"
        />
